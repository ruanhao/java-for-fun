...
public final class BinaryTrees {
	...
	public static void printlnWithColor(BinaryTreeInfo tree) {
		printlnWithColor(tree, null);
	}
	...
	public static void printlnWithColor(BinaryTreeInfo tree, PrintStyle style) {
		if (tree == null || tree.root() == null) return;
		printer(tree, style).printlnWithColor();
	}
