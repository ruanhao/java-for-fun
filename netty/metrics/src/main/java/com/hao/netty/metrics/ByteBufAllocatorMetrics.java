...
import com.hao.netty.metrics.utils.JsonUtils;
...
public class ByteBufAllocatorMetrics {
    ...
    public void testPoolArenaMetrics() {
        ...
        JsonUtils.printPrettyJson(metric);
        ...
        Map<String, Long> metric1 = metrics1.entrySet().stream(
                ...
                .findAny()
                .get();
        JsonUtils.printPrettyJson(metric1);
    ...
    @Test
    @SneakyThrows
    public void showUsedDirectMemory() {
        System.out.println(PlatformDependent.usedDirectMemory());
    }
